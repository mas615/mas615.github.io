...
✔ **Whois 조회는 도메인 및 IP 정보를 얻는 가장 기본적인 정보 수집 기법**  
✔ **네임 서버, 도메인 소유자, 등록 기관 등을 확인할 수 있음**  
✔ **IP 주소 기반 Whois 조회를 통해 IP 할당 조직과 위치 정보를 분석할 수 있음**  
✔ **이 정보를 기반으로 추가적인 OSINT 분석 및 공격 계획 수립 가능**
